...
def get_generational(service, id):
    ...
    planilla = merge_and_sort_dates(ordinarios, extraordinarios)
...
def sort_planilla_by_date(planilla_df):
...
def merge_and_sort_dates(p1, p2):
    ...
    return sort_planilla_by_date(planilla)


service = setup_service()

get_generational(service, "1USCGq_T6GfEC2662Z6iRrSzc1AAoMHM4W13ATAvFs54")
